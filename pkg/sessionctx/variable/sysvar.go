...
var defaultSysVars = []*SysVar{
	...
	{Scope: ScopeGlobal, Name: TiDBMemArbitratorSoftLimit, Value: DefTiDBMemArbitratorSoftLimitText, Type: TypeStr,
		Validation: func(s *SessionVars, normalizedValue string, originalValue string, scope ScopeFlag) (string, error) {
	...
	{Scope: ScopeGlobal, Name: TiDBMemArbitratorMode, Value: DefTiDBMemArbitratorModeText, Type: TypeStr,
		Validation: func(s *SessionVars, normalizedValue string, originalValue string, scope ScopeFlag) (string, error) {
	...
	{Scope: ScopeSession, Name: TiDBMemArbitratorWaitAverse, Value: DefTiDBMemArbitratorWaitAverse, Type: TypeStr,
		Validation: func(s *SessionVars, normalizedValue string, originalValue string, scope ScopeFlag) (string, error) {
	...
	{Scope: ScopeSession, Name: TiDBMemArbitratorQueryReserved, Value: DefTiDBMemArbitratorQueryReservedText, Type: TypeStr,
