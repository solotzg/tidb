...
const (
	...
	// InnodbFtMinTokenSize is the name for 'innodb_ft_min_token_size'.
	InnodbFtMinTokenSize = "innodb_ft_min_token_size" // #nosec G101
	// InnodbFtMaxTokenSize is the name for 'innodb_ft_max_token_size'.
	InnodbFtMaxTokenSize = "innodb_ft_max_token_size" // #nosec G101
	// NgramTokenSize is the name for 'ngram_token_size'.
