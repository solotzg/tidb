...
tiup cluster deploy tzg-ng-cluster v8.5.1 /data2/tongzhigao/tidb/mem-arbitrator-tests/cse-test-cluster.yaml --user root -i /root/.ssh/id_rsa --ignore-config-check -y
